...
class BankTransaction(Base):
    ...
    bank_description: Mapped[str] = mapped_column(String(1000), default="")   # Гүйлгээний утга (банкны)
    bank_counterpart: Mapped[str] = mapped_column(String(100), default="")    # Харьцсан данс
    is_fee: Mapped[bool] = mapped_column(Boolean, default=False)               # Шимтгэл мөр эсэх

    # ── Хэрэглэгчийн гараас оруулах ───────────────────────────────────
    partner_name: Mapped[str] = mapped_column(String(200), default="")         # Харилцагч
    partner_account: Mapped[str] = mapped_column(String(100), default="")      # Данс
    custom_description: Mapped[str] = mapped_column(String(500), default="")   # Гүйлгээний утга (захиалгат)
